...
import static org.agoncal.fascicle.quarkus.http.jsonb.advanced.UtilTest.jsonPath;
...
public class BookTest {
  ...
  static void initFile() throws FileNotFoundException {
    bw = initBufferedWriter("src/main/java/org/agoncal/fascicle/quarkus/http/jsonb/advanced/Book.json");
  }
