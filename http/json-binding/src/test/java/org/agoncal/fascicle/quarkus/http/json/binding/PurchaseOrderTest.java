...
import static org.agoncal.fascicle.quarkus.http.json.binding.CreditCardType.VISA;
...
public class PurchaseOrderTest {
  ...
  static void initFile() throws FileNotFoundException {
    bw = initBufferedWriter("src/main/java/org/agoncal/fascicle/quarkus/http/json/binding/PurchaseOrder.json");
  }
